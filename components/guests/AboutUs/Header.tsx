...
function GuestAboutHeader() {
    return (
        <div className="relative flex justify-center items-center bg-black" style={{zIndex: "10"}}>
            ...
            <div className="h-[200px] sm:h-[320px] lg:h-[400px] lx:h-[600px] overflow-hidden">
            <img src="/image 14.png" style={{ zIndex: "20", backgroundSize: "cover", backgroundPosition: "center", backgroundRepeat: "no-repeat", width: "100%", height: "auto" }} alt="Image 17" />
            </div>
