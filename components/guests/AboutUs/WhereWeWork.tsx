...
function AboutWhereWeWork() {
    return (
        <div className="my-16" id="aboutwherewework">
            ...
            <div className="block xl:hidden relative w-full h-[240px] xl:h-[65vh] xl:w-[60%]" style={{ zIndex: "20", backgroundImage: `image_17.png`, width: "100%", height: "auto", backgroundSize: "cover", backgroundPosition: "center" }}>
                    <img src="/Where we work.jpg" style={{ zIndex: "20", backgroundSize: "cover", backgroundPosition: "center", backgroundRepeat: "no-repeat", width: "100%" }} alt="Image 17" />
                </div>
            <div  className="mx-8 mt-[-50px] xl:ml-20 relative flex flex-col-reverse xl:flex-row items-center justify-between my-10" style={{ zIndex: "500" }}>
                ...
                <div className="hidden xl:block relative w-full h-[200px] xl:h-[65vh] xl:w-[60%]" style={{ zIndex: "20", backgroundImage: `url("/image_17.png")`, width: "100%", height: "auto", backgroundSize: "cover", backgroundPosition: "center" }}>
                <img src="/Where we work.jpg" style={{ zIndex: "20", backgroundSize: "cover", backgroundPosition: "center", backgroundRepeat: "no-repeat", width: "100%" }} alt="Image 17" />
                </div>
            </div>
        </div>
