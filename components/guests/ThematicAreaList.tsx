...
function ThematicAreaList(props: {list: ThematicAreaInterface[]}) {
                ...
                return (
                    <div className="w-full bg-white relative rounded-[10px] overflow-hidden" style={{border: "1px solid grey"}}>
                        ...
                        <div className="mx-4">
                            ...
                            <button className='bg-yellow text-black w-full py-2 my-4 font-bold rounded-[10px]' onClick={() => {router.push(`/thematicarea/${record._id}`)}}>Read</button>
                        </div>
                    </div>
                );
            })}
