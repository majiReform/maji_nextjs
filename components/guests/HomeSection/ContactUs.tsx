...
function GuestContactUs() {
    return (
        <div className="bg-black rounded-[20px] text-white flex gap-8 mx-20 my-10 p-20">
            <div className="w-1/2 flex flex-col gap-10">
                <div>
                    <div className="w-[200px] h-[10px] bg-yellow rounded-[10px] mb-2"></div>
                    <div className="text-[32px] font-bold">Contact Us</div>
                </div>
            ...
            <div className="flex flex-col gap-8 w-1/2">
                <div>
                    <input type="text" className="w-full py-3 px-4 rounded-[10px]" placeholder="Name" />
                </div>

                <div>
                    <input type="text" className="w-full py-3 px-4 rounded-[10px]" placeholder="Email Address" />
                </div>

                <div>
                    <textarea className="w-full py-3 px-4 rounded-[10px]" rows={8} placeholder="Message"></textarea>
                </div>
