"use client"
import { NewsInterface, get, remove, selectPage, selectTotalPages, selectValue } from "@/lib/features/news/newsSlice";
...
function NewsAreaList(props: newslistprop) {
    ...
    return (
        <div>
            ...
            <div className="grid grid-cols-1 xl:grid-cols-4 gap-8 z-40 mb-20">
                {news.length > 0 && news.map((record: NewsInterface) => {
                    if(record) {
                        return (
                                ...
                                <div className="pt-4 flex justify-between w-full">
                                    ...
                                    <Dropdown>
                                        ...
                                        <Menu className='bg-white flex flex-col gap-8 p-4' style={{ zIndex: "80" }}>
                                            <MenuItem className="cursor-pointer" onClick={() => {router.push(`/news/${record!!._id}`)}}>View More</MenuItem>
                                            <MenuItem className="cursor-pointer" onClick={() => {router.push(`/admin/dashboard/news/${record!!._id}`)}}>Edit</MenuItem>
