        ...
        <Box sx={{ width: '100%' }}>
            <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
                <Tabs value={value} onChange={handleChange} aria-label="basic tabs example">
                    <Tab style={{textTransform: "none", fontWeight: "normal"}} label="Edit Profile" {...a11yProps(0)} />
                    <Tab style={{textTransform: "none", fontWeight: "normal"}} label="Password" {...a11yProps(1)} />
                </Tabs>
            </Box>
